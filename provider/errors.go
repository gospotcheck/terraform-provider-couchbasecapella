...
const (
	...
	BucketInvalidName               string = "use letters, numbers, periods (.), underscores (_), or dashes (-). Bucket names cannot exceed 100 characters and must begin with a letter or a number"
